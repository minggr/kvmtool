...
void nvme_complete(void *param, long len);
...
{
    BUILD_BUG_ON(sizeof(NvmeAerResult) != 4);
    BUILD_BUG_ON(sizeof(NvmeCqe) != 16);
    BUILD_BUG_ON(sizeof(NvmeDsmRange) != 16);
    BUILD_BUG_ON(sizeof(NvmeCmd) != 64);
    BUILD_BUG_ON(sizeof(NvmeDeleteQ) != 64);
    BUILD_BUG_ON(sizeof(NvmeCreateCq) != 64);
    BUILD_BUG_ON(sizeof(NvmeCreateSq) != 64);
    BUILD_BUG_ON(sizeof(NvmeIdentify) != 64);
    BUILD_BUG_ON(sizeof(NvmeRwCmd) != 64);
    BUILD_BUG_ON(sizeof(NvmeDsmCmd) != 64);
    BUILD_BUG_ON(sizeof(NvmeRangeType) != 64);
    BUILD_BUG_ON(sizeof(NvmeErrorLog) != 64);
    BUILD_BUG_ON(sizeof(NvmeFwSlotInfoLog) != 512);
    BUILD_BUG_ON(sizeof(NvmeSmartLog) != 512);
    BUILD_BUG_ON(sizeof(NvmeIdCtrl) != 4096);
    BUILD_BUG_ON(sizeof(NvmeIdNs) != 4096);
}
